...
func TestGetResourceNameFinalCoverageEdgeCases(t *testing.T) {
...
func TestGetNameResultFinalCoverageEdgeCases(t *testing.T) {
	provider := Provider()
...
func TestGetResultFinalCoverageEdgeCases(t *testing.T) {
	provider := Provider()

...
func TestGetResourceNameFinalCoverage(t *testing.T) {
	...
	if result != "sttestname" {
		t.Fatalf("Expected 'sttestname', got '%s'", result)
	}
...
func TestGetNameResultFinalCoverage(t *testing.T) {
	provider := Provider()
...
func TestGetResultFinalCoverage(t *testing.T) {
	provider := Provider()
